...
class PlannerAgent(BaseAgent):
    ...
    async def generate_objectives(self, topic: str, case_study: str) -> Dict[str, Any]:
        ...
        # Use base generate to get context injection automatically
        draft_response = await self.generate(draft_prompt)
...
# planner_agent = PlannerAgent() # Instantiated per request now to inject thesis_id
