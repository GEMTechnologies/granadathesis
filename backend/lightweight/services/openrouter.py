...
class OpenRouterService:
    ...
    async def generate_content(
        ...
        Args:
            ...
            stream_callback: Callback function for streaming chunks (job_id, chunk)
            
        Returns:
            Generated content as string or tool calls
        """
        ...
        try:
            print(f"   🚀 Sending request to OpenRouter ({model_key})...")
            if stream:
            ...
            async with httpx.AsyncClient(timeout=120.0) as client:
                if stream:
                    ...
                    # Return full message if it has tool calls, otherwise just content
            ...
            print(f"   ⚠️ OpenRouter Unexpected Error: {e}")
            raise
